...
import EventSuccessExperience from "../../../components/event-experience/EventSuccessExperience";

const EventSuccessPage = async ({ params }: { params: Promise<{ ksuid: string }> }) => {
  ...
  return <EventSuccessExperience eventData={eventData} org={org} eventKsuid={ksuid} />;
};
