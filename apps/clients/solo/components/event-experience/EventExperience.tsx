...
const getHighlightBundleLabel = (event: EventModelType) => {
  const highlightBundleKsuid = typeof event.meta?.highlight_bundle_ksuid === 'string'
...
export default function EventExperience({
  ...
  return (
    <div className="w-full">
      ...
      >
        {process.env.NODE_ENV === 'development' ? <DevThemeDebug theme={organisationTheme} /> : null}
        <EventHeroBanner event={event} org={org} theme={organisationTheme} />
        <EventFactsPanel event={event} highlightedPassLabel={highlightPassLabel} />
            ...
            <div className="p-6" style={{ color: "var(--scheme-surface-text)" }}>
              ...
              <div className="mt-8 px-5 py-4">
                ...
                <p className="mt-2 text-lg font-semibold">
                  {startDate ? format(startDate, 'EEEE d MMMM yyyy, h:mmaaa') : 'Date TBC'}
                </p>
                {endDate ? (
