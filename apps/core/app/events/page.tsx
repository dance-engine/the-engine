...
const EventPage = async () => {  
  return (
    <div className="flex flex-col justify-start items-center relative">
      ...
      <PageListingClient entity={"EVENT"} columns={["name","starts_at","starts_at","ends_at","category","number_sold","meta.saved","version"]} formats={[undefined,'date','time','time',undefined,undefined,'icon',undefined]}/>
    </div>
  );
};
