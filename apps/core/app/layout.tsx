              ...
              <div className="flex items-center gap-x-4 lg:gap-x-6">
                ...
                <div className="relative">
                  ...
                  <div className="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabIndex={-1}>
                    ...
                    <a href="#" className="block px-3 py-1 text-sm/6 text-gray-900" role="menuitem" tabIndex={-1} id="user-menu-item-0">Your profile</a>
                    <a href="#" className="block px-3 py-1 text-sm/6 text-gray-900" role="menuitem" tabIndex={-1} id="user-menu-item-1">Sign out</a>
                  </div>
                </div>
              </div>
            </div>
