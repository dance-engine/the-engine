...
const SuperAdminIcon = (<svg className="size-6 shrink-0 text-primary-text group-hover:text-white" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
  <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9A2.25 2.25 0 0 1 5.25 16.5v-6A2.25 2.25 0 0 1 7.5 8.25h9a2.25 2.25 0 0 1 2.25 2.25v6a2.25 2.25 0 0 1-2.25 2.25Z" />
  <path strokeLinecap="round" strokeLinejoin="round" d="M9 8.25V6a3 3 0 1 1 6 0v2.25M12 12.75h.008v.008H12v-.008Z" />
</svg>)
