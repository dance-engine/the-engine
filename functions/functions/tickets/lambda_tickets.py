...
# from _pydantic.models.tickets_models import TicketsObject, TicketsResponse
#from _pydantic.models.models_extended import TicketsModel
...
def get(organisationSlug: str, public: bool = False, actor: str = "unknown") -> TicketsObject:
    '''
    You expect me to return an instance of TicketsObject.
    '''
    # TODO: implement
