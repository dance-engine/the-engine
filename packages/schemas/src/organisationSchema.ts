...
export const organisationSchema = z.object({
  ...
  colour_surface_light: z.string().optional().describe("Light surface colour for the organisation"),
  colour_surface_dark: z.string().optional().describe("Dark surface colour for the organisation"),
