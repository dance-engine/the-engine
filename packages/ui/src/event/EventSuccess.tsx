    ...
    <div className="w-full">
      ...
      >
        {process.env.NODE_ENV === "development" ? (
          <DevThemeDebug theme={theme} />
        ) : null}
        {event ? (
          <EventHeroBanner event={event} org={org} theme={theme} />
        ) : null}
          ...
          <section className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr]">
            ...
            >
              ...
              <p
                ...
                style={{ color: "var(--scheme-surface-text)" }}
              >
                Thanks for booking with {org.name}. Your transaction was
                successful and your ticket details will be sent to the email
                address you entered at checkout.
              </p>
              <p
                className="mt-4 max-w-2xl text-base leading-7"
                style={{ color: "var(--scheme-surface-muted)" }}
              >
                If the email does not arrive shortly, check your spam folder
                first. You can also keep this page handy as a reminder of the
                event details below.
              </p>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <Link
                  ...
                  style={{
                    ...
                    outline:
                      "1px solid color-mix(in srgb, var(--scheme-surface-text) 16%, transparent)",
                  }}
                >
                  Continue browsing
                </Link>
