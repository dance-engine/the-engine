          ...
          <label key={index} className="flex items-center gap-2 capitalize leading-none">
            ...
            <div className="group grid size-4 grid-cols-1">
              <input
                ...
                className="col-start-1 row-start-1 appearance-none rounded-sm border border-gray-300 bg-white checked:border-dark-highlight checked:bg-dark-highlight indeterminate:border-dark-highlight indeterminate:bg-dark-highlight focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-dark-highlight disabled:border-gray-300 disabled:bg-gray-100 disabled:checked:bg-gray-100 forced-colors:appearance-auto"
              />
              {/* This is the tick */}
              <svg
                fill="none"
