...
const DestructiveButton = ({className, record, onClick, children}: {className?:string, record?: Record<string, unknown>, onClick: (record: Record<string, unknown>) => void | Promise<void>, children?: React.ReactNode}) => {
